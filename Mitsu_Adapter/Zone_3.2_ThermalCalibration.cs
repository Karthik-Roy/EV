...
namespace SOPS.Mitsu_Adapter
{
    ...
    internal class Z32_ThermalCalibration : MitsuBaseClass
    {
        ...
        public Z32_ThermalCalibration(int pLCLogicalStation, int adapterPortNumber, int queryIntervalinMS) : base(pLCLogicalStation, adapterPortNumber, queryIntervalinMS)
        {
