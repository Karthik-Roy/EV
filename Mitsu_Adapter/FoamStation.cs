...
namespace SOPS.Mitsu_Adapter
{
    ...
    internal class FoamStation : MitsuBaseClass
    {
        ...
        Message mFoamStation = new Message("FoamStationData");

        public FoamStation(int pLCLogicalStation, int adapterPortNumber, int queryIntervalinMS) : base(pLCLogicalStation, adapterPortNumber, queryIntervalinMS)
        {
        ...
        public override void StartPLCTimer()
        {
            ...
            _mAdapter.AddDataItem(mFoamStation);
        ...
        #region FoamStation
        private void GetFoamStation()
        {
            const int userreg = 14238;
            const int opshift = 14270;
            const int stackbarcode = 6010;
            ...
            int SI_No = 0;
            _mitsuPLC.GetDevice("D14234", out SI_No);
            ...
            int lineNumber = 0;
            _mitsuPLC.GetDevice("D14334", out lineNumber);
            float linenum = lineNumber / 10;

            int glueWeight = 0;
            _mitsuPLC.GetDevice("D14336", out glueWeight);
