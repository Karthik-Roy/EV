...
namespace SOPS.Mitsu_Adapter
{
	...
	internal class Z31_FoamCalibration : MitsuBaseClass
	{
		...
		Message mFoamCalibration = new Message("FoamCalibrationData");
		
		public Z31_FoamCalibration(int pLCLogicalStation, int adapterPortNumber, int queryIntervalinMS) : base(pLCLogicalStation, adapterPortNumber, queryIntervalinMS)
		{
		...
		public override void StartPLCTimer()
		{
			...
			_mAdapter.AddDataItem(mFoamCalibration);
		...
		#region FoamCalibration
		private void GetFoamCalibration()
		{
			const int userreg = 12576;
			const int opshift = 12593;
			string userdata = string.Empty;
			string shift = string.Empty;
		

			int SI_No = 0;
			_mitsuPLC.GetDevice("D12572", out SI_No);
