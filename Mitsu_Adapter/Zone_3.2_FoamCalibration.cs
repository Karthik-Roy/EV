...
namespace SOPS.Mitsu_Adapter
{
    ...
    internal class Z32_FoamCalibration : MitsuBaseClass
    {
        ...
        public Z32_FoamCalibration(int pLCLogicalStation, int adapterPortNumber, int queryIntervalinMS) : base(pLCLogicalStation, adapterPortNumber, queryIntervalinMS)
        {
