...
namespace SOPS.Mitsu_Adapter
{
    ...
    internal class Z32_InserationCalibration : MitsuBaseClass
    {
        ...
        public Z32_InserationCalibration(int pLCLogicalStation, int adapterPortNumber, int queryIntervalinMS) : base(pLCLogicalStation, adapterPortNumber, queryIntervalinMS)
        {
